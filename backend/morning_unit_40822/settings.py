"""
Django settings for morning_unit_40822 project.
...
ROOT_URLCONF = 'morning_unit_40822.urls'
...
WSGI_APPLICATION = 'morning_unit_40822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_unit_40822 API",
    "DESCRIPTION": "API documentation for morning_unit_40822 App",
    "VERSION": "v1",
}
